...
const Home = () => {
  return (
    <div className='flex md:flex-row-reverse lg:flex-row sm:flex-col-reverse xs:flex-col-reverse max-[320px]:flex max-[320px]:flex-col-reverse max-[414px]:flex-col-reverse min-h-screen sm:mt-12 xs:mt-12 max-[320px]:mt-10 max-[414px]:mt-10'>
      <div className={`${styles.paddingY} basis-2/4`}>
        ...
        {hero.map((words) => (
          ...
          <div className={`${styles.paddingX} text-[#3264f5] flex justify-start items-center gap-3 flex-row-2 md:mb-5`}>
            <Link to={'#'}><button className='pt-[10px] px-[30px] font-[600] rounded-[30px] bg-white border-white border-2 py-[10px] hover:bg-orange-400 focus:bg-orange-900 sm:py-2 xs:py-0.5 gap-3 active:bg-orange-800 max-[320px]:pt-2 px-4'>Register</button></Link>
