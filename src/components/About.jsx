...
const About = () => {
  ...
  return (
    <div>
      <div className={` ${styles.paddingX} flex 2xl:flex-row xl:flex-row gap-7 flex-col max-xs:flex-col lg:flex-row md:flex-row`}>
        <div className={`basis-2/6 xl:2/6 md:basis-2/6`}>
          {about_col.map((abt) => (
        ...
        <div className='basis-4/6 xl:basis-4/6 flex w-full gap-6 flex-col xl:flex-row 2xl:flex-row md:gap-y-5 lg:flex-row max-w-100 flex-wrap max-lg:flex-row max-md:flex-col md:basis-3/6'>

          {about.map((abt) => (
            <div className='group shadow-xl hover:bg-gradient-to-r from-orange-400 to-red-700 p-[1.5rem] border-2 rounded shadow-[0 .125rem .25rem rgba(0,0,0,.075)] border-[#dee2e6] mx-1 w-full xl:w-80 lg:w-[15rem]'>
          ...
          {custom.map((cus) => (
            <div className=' group shadow-lg hover:bg-gradient-to-r from-orange-400 to-red-700 p-7 hover:text-white mx-1 w-full p-[1.5rem] border-2 rounded shadow-[0 .125rem .25rem rgba(0,0,0,.075)] border-[#dee2e6] xl:w-80 lg:w-[15rem]'>
