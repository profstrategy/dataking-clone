...
const Navbar = () => {
  ...
  return (
    <nav className={`${styles.paddingX} w-full fixed top-0 py-4 flex items-center bg-gradient-to-r from-orange-400 to-red-700 315deg ${navbar ? ' bg-gradient-to-r from-orange-600 to-red-1000' : 'bg-gradient-to-r from-orange-400 to-red-700'}`}>
